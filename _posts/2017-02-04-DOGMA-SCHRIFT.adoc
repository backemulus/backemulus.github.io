...
Schrift _ist_ und schrift _wird_ verbindlich. Geschriebenes besorgt die verringerung von variierbarkeit durch ihre standfestigkeit, während zugleich gilt: primär ist gechriebenes. So wird dann für dogmatische kultur nicht nur schrift, sondern gar _die Schrift_ (die Bibel) als ständige referenzmöglichkeit und referenzpflicht bedeutsam. 
