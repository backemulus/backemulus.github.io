...
Daraus folgt, daß auch die mächtigkeit einer kirche nicht ohne abhängigkeit von machtstrukturen diese machtstrukturen aufrecht erhalten können. Wer böse hinterkämmler sucht, wird genügend finden – wer aber die machtverhältnisse auf böse hinterkämmler reduziert, wird einen feind, aber keine funktionablen erklärungen erhalten.
