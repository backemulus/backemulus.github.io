...
_Die folgende untersuchungsskizze ist versuch und aufruf. Versuch auf die übliche ordnung für theoretische arbeit (informierung–konzeptualisierung–formulierung) umzukehren und mit der formulierung eines losen konzepts zu beginnen, um erst danach die informierung und konzeptionsmodifikationen zu besorgen. Dafür bitte ich um theoretische unterstützung: Um literatur- und quellenempfehlung, beiträge in form von ideen, gedanken, einwänden, verweisen, die stützen und ausbauen sowie einschränken und problematisieren. Klar ist: ich bin inkompetent dem gegenstand gegenüber: weder bin ich informiert, noch könnte ich dafür sorgen, denn die informationen sind legion. Dies gilt aber für jeden und merkt jeder, der ein wenig ließt: mehr lesen bedeutet, von mehr uninformiertheit erfahren. Gerade deshalb lohnt es sich, neues auszuprobieren, so unsicher das ergebnis ist. Der versuch über die entstehung des atheismus ist damit zugleich ein experiment über theoretisches arbeiten. Die leserin ist gewarnt – nicht nur der autor, auch sie trägt ein risko. Theoretische risiken sind glücklicherweise recht harmlos: zeitverschwendung und verwirrung sind die schlimmst erwartbaren fälle._
...
[[bookmark-12, {12}]]\{12} Deshalb ist eine beschreibung von talkshows aufsuchenden atheisteninszenateure als atheisten in genutzten sinne unergiebig. Hier käme man mit einer sektentheorie vermutlich weiter.
...
[6] Von mir: http://www.mulus.science/2017/01/15/FUNDAMENTAL-RADIKAL.html[Fundamental/Radikal].
