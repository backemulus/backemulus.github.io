...
Das netzwerk ist vernetzung <<footnote-2>>, unterscheidbar nach struktur- und prozeßseite: die strukturseite ist das durch vernetzung entstandene netz, die prozeßseite ist die vernetzende netzbildung. 
