...
Das internet ist ein netzwerk. Nicht nur innoviert das internet eine neue struktur, sondern es innoviert zugleich neue prozesse der strukturbildung. Dies bedeutet, daß das internet nicht bloß als struktur innerhalb
