...
[[bookmark-12, {12}]]\{12} Deshalb ist eine beschreibung von talkshows aufsuchenden atheisteninszenateuren als »atheisten« im genutzten sinne unergiebig. Hier käme man mit einer sektentheorie vermutlich weiter.
